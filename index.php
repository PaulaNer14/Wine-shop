...
<body>
    ...
    <section class="super-deal-section" style="background-image: url(images/bg.jpg);">
        <div class="container">
            <div class="row">
        ...
        <div class="container">
            <div class="row">
                <div class="dark-headingstyle-one text-center">
                    <h2 class="dart-heading">Produse recomandate</h2>
                        ...
                        <ul id="tabSix" class="nav nav-tabs">
                            <li class="active">
                                <a href="#contentSix-one" data-toggle="tab">
                                    <p>Cel mai bine vandut</p>
                                </a>
                            </li>
                            <li>
                                <a href="#contentSix-two" data-toggle="tab">
                                    <p>Cel mai nou produs</p>
                                </a>
                            </li>
                        </ul>
